...
if("shinydashboard" %in% installed.packages()[,1] == FALSE){
...
ui <- fluidPage(
  ...
  titlePanel(title=div(img(src="Logo_FSP_EC_RGB - Copy.png", height = 50), "Fertilizer Dashboard"), windowTitle = "Fertilizer Dashboard"), #,align = "center")
  ...
  #  title=div(img(src="Logo_FSP_EC_RGB - Copy.png", height = 35), 
             ...
             tabPanel("Market Overview", fluid = TRUE,
                      fluidRow(column(12,
                                                                 ...
                                                                 fluidRow(
                                                                   ...
                                                                   column(12, 
                                                                          ...
                                                                          selectInput("marketOverviewMonth", h3(""), 
                                                                                      choices = list("Apr. 2023"=16, "Mar. 2023"=15,"Feb. 2023" = 1, "Jan. 2023"= 2, "Nov. 2022" =  4,
                                      ...
                                      helpText("Last update: May 1, 2023 / Next update: June 1, 2023")
...
server <- function(input, output) {
  ...
  shinyalert(
    ...
    markets: fertilizer prices, fertilizer trade, fertilizer use, and fertilizer production. For a monthly 
    summary of the latest market developments, click on the market overview tab.",
    size = "m", 
    closeOnEsc = TRUE,
...
#   })
  ...
  importdep_world_gg <- importdep_world %>%
    ggplot() +
    geom_sf(aes(fill = value, text = text, color = NAME_ENGL), show.legend = T) +
  # scale_fill_viridis_b("")+
...
#deployApp(appName = "FertilizerDashboard13Jan22")