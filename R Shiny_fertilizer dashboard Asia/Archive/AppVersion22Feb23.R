                          ...
                          column(12,
                                 column(3,
                                        wellPanel( 
                                          ...
                                          radioButtons(inputId = "impExpQuantity_year", 
                                                       label = "Year:",
                                                       choices = list("2020" = "2020", "2010" = "2010", "2000" = "2000"), 
                                                       selected = "2020"
                                          )
             ...
             tabPanel("Use", fluid = TRUE,
                      ...
                      conditionalPanel(
                        ...
                        fluidRow(column(12,
                                        column(3, 
                                               wellPanel(
                                                 radioButtons(inputId = "yearApplicationRt",
                                                              label = "Select year:",
                                                              choices = list("2020" = "2020", "2010" = "2010", "2000" = "2000"), 
                                                              selected = "2020"
                      ...
                      conditionalPanel(
                        ...
                        fluidRow(column(12,
                                        column(3, 
                                               wellPanel(
                                                 radioButtons(inputId = "yearUseYields",
                                                              label = "Select year:",
                                                              choices = list("2020" = "2020", "2010" = "2010", "2000" = "2000"), 
                                                              selected = "2020"
                      ...
                      fluidRow(column(12,
                                      column(3, 
                                             wellPanel(
                                               ...
                                               radioButtons(inputId = "productionYear",
                                                            label = "Select year:",
                                                            choices = list("2020" = "2020", "2010" = "2010", "2000" = "2000"), 
                                                            selected = "2020"
                                               ),
                                               ...
                                               radioButtons(inputId = "productionMapOrBubble",
                                                            label = "Select:",
                                                            choices = list("Show as map" = 1, "Show as bubble chart" = 2), 
                                                            selected = 2
                                               )
...
server <- function(input, output) {
  ...
  impQuant <- reactive({
    usebroad %>%
      filter(`variable` == "Import Quantity") %>%
      filter(`Product` == input$impExpQuantity_nutrient) %>%
  ...
  production <- reactive({
    usebroad %>%
      ...
      #filter(`Product` == input$useNutrient) %>%
      #filter(`Year` == input$useYear)%>%
      filter(`Product` == input$productionNutrient) %>%
  ...
  output$productionBubble <- renderggiraph({
    ...
    ggiraph(code = print(ggProduction))
  ...
  output$productionMap <- renderPlotly({
    ...
    productionMap_plotly <- productionMap_gg %>%
      ggplotly(tooltip = "text") %>%
      style(hoveron = "fill") 
