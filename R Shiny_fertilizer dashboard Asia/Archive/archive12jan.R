###THIS IS AN ARCHIVED WORKING VERSION 12Jan22 11am
             ...
             tabPanel("Market characteristics", fluid = TRUE,
                      ...
                      column(12,tabsetPanel(id="MarketCharacteristics_tabs",
                                            ...
                                            tabPanel("Country profiles",
                                                     fluidRow(column(12,
                                                                     helpText("In these tabs we would transfer and consolidate based on the tabs
                                                  on the existing dashboard. Because having so many similar tabs (as in the existing dashboard)
                                                  could be confusing, this version consolidates the number
                                                  of tabs. For example, instead of having net importers and import dependency as 
                                                  seperate tabs, we would have them as one and then having inputs that the user could
                                                  select to show the various aspects within one tab.")               
